...
// https://d3js.org/d3-time/ Version 1.0.2. Copyright 2016 Mike Bostock.
    ...
    exports.default = {
        ...
        d3_addText: function d3_addText(svg, enter, labels, classPrefix) {
            enter.append("text").attr("class", classPrefix + "label").attr;
        ...
        function legend(svg) {
            ...
            if (orient === "vertical") {
                ...
                cellTrans = function cellTrans(d, i) {
                    ...
                    return "translate(0, " + (height + i * shapePadding)+ 40 + ")";
                };

                textTrans = function textTrans(d, i) {
                    return "translate(" + (maxW + labelOffset) + "," + (shapeSize[i].y + shapeSize[i].height / 2 + 5) + 40 + ")";
                };
            } else if (orient === "horizontal") {
                cellTrans = function cellTrans(d, i) {
                ...
                textTrans = function textTrans(d, i) {
                    return "translate(" + (shapeSize[i].width * textAlign + shapeSize[i].x) + "," + (maxH + labelOffset) + 40 + ")";
                };
            }
